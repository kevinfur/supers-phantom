...
page.open('https://www.veadigital.com.ar/Login/PreHome.aspx');
...
var links = page.evaluate(function() {
    return [].map.call(document.querySelectorAll("#divGrupos a[href^='javascript:VerGon']"), function(link) {
...
if (links){
	for (var i=0; i<links.length;i++){	
		...
		//var start = Date.now();	
		//do { phantom.page.sendEvent('mousemove'); } while ((Date.now() - start) < 500);
		...
		do { phantom.page.sendEvent('mousemove'); } while ( continueNextCategory == false );
